<?php
namespace Marmot\Application\User\Model;
...
class UserTest extends TestCase
{
    ...
    {
        $this->user = $this->getMockBuilder('Marmot\Application\User\Model\User')
    ...
    public function testUserEncryptPasswordWithSalt()
    {
        ...
        //初始化一个新的用户,再次加密
        $anotherUser = $this->getMockBuilder('Marmot\Application\User\Model\User')
                            ->getMockForAbstractClass();
