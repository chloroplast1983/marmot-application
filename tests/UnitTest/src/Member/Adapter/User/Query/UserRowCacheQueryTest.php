<?php
namespace Marmot\Application\Member\Adapter\User\Query;
...
class UserRowCacheQueryTest extends TestCase
{
    ...
    public function testCorrectCacheLayer()
    {
        $this->assertInstanceof(
            'Marmot\Application\Member\Adapter\User\Query\Persistence\UserCache',
    ...
    {
        $this->assertInstanceof(
            'Marmot\Application\Member\Adapter\User\Query\Persistence\UserDb',
